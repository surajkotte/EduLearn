...
import TestQuestionsComponent from "./TestQuestionsComponent";
...
const TestCompnent = () => {
    ...
    const fetchData = async () => {
      ...
      if (responseData) {
        ...
        if (testConfigResponse?.messageType == "S") {
          ...
          setSecondsLeft((testConfigResponse?.data?.timeLimit || 0) * 60);
        }
      }
    };
    fetchData();
  ...
  //     }
  //   };
  // }, [startTest, isRunning, secondsLeft]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      {startTest && (
        ...
        //                     )}`}
        //                     disabled={
        //                       questionInfo?.answerSelected ? true : false
        //                     }
        //                   >
        //                     <div className="flex items-center space-x-3">
